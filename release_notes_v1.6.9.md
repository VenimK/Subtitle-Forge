...
- Enhanced dependency detection for all external tools (mkvmerge, mkvextract, ffmpeg, vobsub2srt, deno, etc.)
...
- Fixed runtime errors related to mkvmerge, mkvextract, and deno path handling
